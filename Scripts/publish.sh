...
bundle exec fastlane gym --verbose --include_bitcode true --include_symbols true --clean --workspace HyBid.xcworkspace --scheme PubnativeLiteDemo --archive_path $ARCHIVE_PATH --output_directory $OUTPUT_FOLDER --export_options $OPTIONS_PLIST
