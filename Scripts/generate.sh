...
# GENERATE
xcodebuild -workspace PubnativeLite.xcworkspace -scheme PubnativeLite -sdk iphoneos -configuration Release clean build CODE_SIGN_IDENTITY="iOS Distribution" CODE_SIGNING_REQUIRED=NO CONFIGURATION_BUILD_DIR=$IPHONEOS_PATH | xcpretty -c
