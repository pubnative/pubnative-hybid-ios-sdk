...
6.4 No assignment. Claims of Licensee against VGE under these License Terms may not be
  ...
  s.authors      = { "Eros Garcia Ponte" => "eros.ponte@pubnative.net", "Fares Benhamouda" => "fares.benhamouda@pubnative.net", "Orkhan Alizada" => "orkhan.alizada@pubnative.net", "Jose Contreras" => "jose.contreras@verve.com", "Aysel Abdullayeva" => "aysel.abdullayeva@verve.com"  }
  s.platform     = :ios

  s.ios.deployment_target = "12.0"
  s.source       = { :git => "https://github.com/pubnative/pubnative-hybid-ios-sdk.git", :tag => "3.8.0" }
  s.resource_bundle = {
  ...
  s.subspec 'ATOM' do |atom|
    ...
    atom.dependency 'ATOM-Standalone'
  end
