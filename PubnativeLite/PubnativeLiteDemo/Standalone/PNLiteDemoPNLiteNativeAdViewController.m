...
{
    [HyBidSKAdNetworkViewController.shared presentSKStoreProductViewControllerWithProductParameters: productParameters adFormat:HyBidReportingAdFormat.NATIVE isAutoSKPVC:NO];
}
@end
