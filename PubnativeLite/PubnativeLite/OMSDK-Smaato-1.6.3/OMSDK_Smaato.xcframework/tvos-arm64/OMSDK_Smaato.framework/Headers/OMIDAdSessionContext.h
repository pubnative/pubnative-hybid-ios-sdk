 ...
 */
@interface OMIDSmaatoAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDSmaatoPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDSmaatoPartner *)partner
                               ...
                               resources:(NSArray<OMIDSmaatoVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
...
- (nullable instancetype)initWithPartner:(OMIDSmaatoPartner *)partner
                              ...
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                           universalAdID:(nullable OMIDSmaatoUniversalAdID *)universalAdID
                                   error:(NSError *_Nullable *_Nullable)error;
