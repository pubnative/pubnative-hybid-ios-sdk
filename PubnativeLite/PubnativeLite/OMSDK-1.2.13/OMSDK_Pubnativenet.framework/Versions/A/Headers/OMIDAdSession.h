 ...
 */
@interface OMIDPubnativenetAdSession : NSObject

/*!
 * @abstract The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly, nonnull) OMIDPubnativenetAdSessionConfiguration *configuration;
/*!
 ...
 */
- (nullable instancetype)initWithConfiguration:(nonnull OMIDPubnativenetAdSessionConfiguration *)configuration
                              adSessionContext:(nonnull OMIDPubnativenetAdSessionContext *)context
