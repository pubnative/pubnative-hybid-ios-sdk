...
@implementation HyBidATOMManager
...
+ (void)fireAdSessionEventWithData:(HyBidAdSessionData *)data
{
    ...
    if (jsonData && !err) {
        ...
        if (jsonString.length > 0) {
            ...
            [HyBidATOMManager reportAdSessionDataSharedEventWithAdSessionDict:adSessionDict];
        }
    }
#endif
}
