...
- (BOOL)startNotifier {
    ...
    if (SCNetworkReachabilitySetCallback(_reachabilityRef, PNLiteReachabilityCallback, &context)) {
...
- (PNLiteNetworkStatus)networkStatusForFlags:(SCNetworkReachabilityFlags)flags {
    ...
    if ((flags & kSCNetworkReachabilityFlagsReachable) == 0) {
        ...
        return PNLiteNetworkStatus_NotReachable;
    }
    ...
    if ((flags & kSCNetworkReachabilityFlagsConnectionRequired) == 0) {
         ...
         */
        returnValue = PNLiteNetworkStatus_ReachableViaWiFi;
    }
    ...
    if ((flags & kSCNetworkReachabilityFlagsIsWWAN) == kSCNetworkReachabilityFlagsIsWWAN) {
         ...
         */
        returnValue = PNLiteNetworkStatus_ReachableViaWWAN;
    }
    return returnValue;
}
